...
import { Home, Users, BarChart2, Settings, CalendarDays } from 'lucide-react'
...
export const MobileNav: React.FC = () => (
  <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white/95 dark:bg-slate-900/95 backdrop-blur border-t border-slate-200 dark:border-slate-800 flex items-center md:hidden z-40">
